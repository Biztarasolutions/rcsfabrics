...
export default function ProductDetailPage({ params }: { params: { slug: string } }) {
  ...
  if (isError || !PRODUCT) return <div className="flex min-h-screen items-center justify-center text-center py-20"><div><p className="text-6xl">🧶</p><h2 className="mt-4 text-2xl font-bold">Product not found</h2><button onClick={() => window.history.back()} className="button-primary mt-6 px-8 py-3">Go Back</button></div></div>;
